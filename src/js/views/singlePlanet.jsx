...
export const SinglePlanet = props => {
	...
	return (
        ...
        <img src={"https://starwars-visualguide.com/assets/img/planets/" + (id) + ".jpg"} className="mb-4" alt="Luke"style={{height:"300px", width:"300px"}}/>
			...
			<h5 className="display-4 text-end me-5 ms-4 mt-3">{store.detallesPlanets.name}</h5>
...
<hr className="my-4 text-danger text-center" style={{height: "5px"}}/>	
					<div className="row row-cols-6 text-danger text-center">
						<div className="col"><h5>Name</h5> <p className="fw-normal">{store.detallesPlanets.name}</p></div>
						<div className="col"><h5>Terrain</h5> <p className="fw-normal">{store.detallesPlanets.terrain}</p></div>
						<div className="col"><h5>Population</h5><p className="fw-normal">{store.detallesPlanets.population}</p></div>
					</div>
			</div>
</>
	);
